...
def resnet8(**kwargs):
  model = ResNet_Cifar(BasicBlock, [1, 1, 1], width=1, **kwargs)
  return model

def resnet14(**kwargs):
  model = ResNet_Cifar(BasicBlock, [2, 2, 2], width=1, **kwargs)
  return model

def resnet20(**kwargs):
  model = ResNet_Cifar(BasicBlock, [3, 3, 3], width=1, **kwargs)
  return model

def resnet26(**kwargs):
  model = ResNet_Cifar(BasicBlock, [4, 4, 4], width=1, **kwargs)
  return model

def resnet32(**kwargs):
  model = ResNet_Cifar(BasicBlock, [5, 5, 5], width=1, **kwargs)
  return model
